...
#
# Script generated by Vivado on Mon Apr 07 14:09:28 CDT 2025
...
#
# Usage        : main_memory.sh
#                main_memory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                main_memory.sh [-reset_run]
#                main_memory.sh [-reset_log]
#                main_memory.sh [-help]
#
...
#                script (type 'main_memory.sh -help' for more information).
#
...
# script info
echo -e "main_memory.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./main_memory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.main_memory xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.main_memory -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/cole/Documents/SoC/SoC.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log main_memory_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: main_memory.sh [-step]\n\
Usage: main_memory.sh [-lib_map_path]\n\
Usage: main_memory.sh [-reset_run]\n\
Usage: main_memory.sh [-reset_log]\n\
Usage: main_memory.sh [-keep_index]\n\
