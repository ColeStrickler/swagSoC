...
HD_PWD='/home/cole/Documents/SoC/SoC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_fallthrough.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_fallthrough.tcl
